...
from utils import face_encodings, face_rects, nb_of_matches

def face_recognition_images(example):
    ...
    # get the 128-d face embeddings for
    ...
    for rect, name in zip(face_rects(image), names):
        ...
        cv2.rectangle (image, (x1, y1), (x2, y2), (20, 255, 20), 2) 
